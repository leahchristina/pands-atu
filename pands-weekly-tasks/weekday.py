...
## I'm using this import & strftime method from w3 schools: https://www.w3schools.com/python/python_datetime.asp
...
# 3. Weekday() assigns a number - Monday=0, Tuesday=1, Saturday=5...
